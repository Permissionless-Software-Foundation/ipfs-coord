...
class PeerUseCases {
  ...
  // TODO: Connect to peer through circuit relays. This ensures a short path
  // between peers, *before* broadcasting the OrbitDB message to them.
  // Can re-use a lot of code in this-node-use-cases.js/refreshPeerConnections()
  // async connectToPeer()
  ...
  async sendPrivateMessage (peerId, str, thisNode) {
    try {
      ...
      // TODO: Connect to peer through Circuit Relay, using connectToPeer()
