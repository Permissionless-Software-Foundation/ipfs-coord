...
class Schema {
  constructor (schemaConfig) {
    ...
    this.state = {
      ...
      apiInfo:
        schemaConfig.apiInfo ||
        'You should put an IPFS hash or web URL here to your documentation.'
    }

    // Default JSON-LD Schema
    this.state.announceJsonLd = schemaConfig.jsonLd || {
      '@context': 'https://schema.org/',
      '@type': 'WebAPI',
      name: this.state.name,
      description:
        'IPFS Coordination Library is used. This app has not been customized.',
      documentation: 'https://www.npmjs.com/package/ipfs-coord',
      provider: {
        '@type': 'Organization',
        name: 'https://PSFoundation.cash'
      },
      identifier: this.ipfsId
    }
  }
