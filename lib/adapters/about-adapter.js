/*
  ...
  3/2/22 CT: TODO: move this library into the pubsub-adapter directory and make
  it a sub-library attached to the index.js library in that directory.
*/
...
class AboutAdapter {
  ...
  async sendRPC (ipfsId, cmdStr, id, thisNode) {
    ...
    try {
      ...
      // Callback wrapper.
      cb = inData => {
        // console.log('relayMetrics event handler fired. inData: ', inData)
        retData = inData
      }
